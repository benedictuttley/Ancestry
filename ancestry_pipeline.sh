...
########## MODULE 6 START ##########
$PLINK --bfile ../data/met583-test/met583-test-qc-v9 --check-sex --out ../temp/met583-test-qc-v9
awk 'BEGIN{printf("%s\t%s\n", "FID", "IID")};{ if ($4 == 2) {printf("%s\t%s\n", $1, $2)}}' \
    ../temp/met583-test-qc-v9.sexcheck > ../results/met583-test-female.keep
########## MODULE 6 END ##########
